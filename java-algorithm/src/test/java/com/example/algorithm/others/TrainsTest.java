...
class TrainsTest {
	...
	private void testDistanceOfRoute() {
	...
	private void testNumberOfRouteMaxStops() {
...
//        printRoutes(routes);
	...
	private void testNumberOfRouteExactlyStops() {
		Deque<String> routes = new ArrayDeque<>();
...
//        printRoutes(routes);
	...
	private void testLengthOfShortestRoute() {
		Deque<String> routes = new ArrayDeque<>();
...
//            printRoutes(routes);
	...
	private void testNumberOfRoutes() {
		Deque<String> routes = new ArrayDeque<>();
